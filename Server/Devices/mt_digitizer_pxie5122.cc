...
namespace mantis
{
    ...
    bool digitizer_pxie5122::allocate( buffer* a_buffer, condition* a_condition )
    {
        f_buffer = a_buffer;
    ...
    bool digitizer_pxie5122::deallocate( buffer* a_buffer )
    {
    ...
    bool digitizer_pxie5122::initialize( const param_node* a_config )
    {
